...
// Custom code of Facets mbl js 
// let filterTitle = document.querySelectorAll(".filter-content-title");
// let filtervalueMbl = document.querySelectorAll(".filter-content-value");

// filterTitle.forEach((titleElement) => {
//     titleElement.addEventListener("click", function () {
//         filterTitle.forEach((otherTitleElement) => {
...
function handleFiltering(titleElement) {
  ...
  filtervalueMbl.forEach((valueElement) => {
    ...
    let facetItem = valueElement.querySelectorAll("li");
